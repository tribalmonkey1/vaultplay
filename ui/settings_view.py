...
class SettingsView(QWidget):
    ...
    def _build_wine_page(self) -> QScrollArea:
        ...
        refresh_pdb_row = SettingsRow(
            ...
            "Re-fetch compatibility ratings for all games with a Steam ID.")
        self.pdb_refresh_btn = ActionButton("Refresh All")
    ...
    def _on_pdb_refresh_done(self, count: int):
        self.pdb_status_lbl.setText(f"✓ Done — {count} games updated")
        self.pdb_refresh_btn.setText("Refresh All")
